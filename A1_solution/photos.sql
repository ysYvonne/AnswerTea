...
-- -----------------------------------------------------
-- Table `photos`.`storedphoto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `photos`.`storedphoto` ;

CREATE TABLE IF NOT EXISTS `photos`.`storedphoto` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `filename` VARCHAR(128) NOT NULL,
  `type_id` INT NOT NULL,
  `photo_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_storedphoto_type1_idx` (`type_id` ASC),
  INDEX `fk_storedphoto_photo1_idx` (`photo_id` ASC),
  CONSTRAINT `fk_storedphoto_type1`
    FOREIGN KEY (`type_id`)
    REFERENCES `photos`.`type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_storedphoto_photo1`
...
INSERT INTO `photos`.`type` (`id`, `label`) VALUES (3, 'face_detected');
